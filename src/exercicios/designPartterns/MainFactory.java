...
import exercicios.exercicio7.Divisao;
import exercicios.exercicio7.Exponenciacao;
import exercicios.exercicio7.Multiplicacao;
import exercicios.exercicio7.Nodo;
import exercicios.exercicio7.Operacao;
import exercicios.exercicio7.Percent;
import exercicios.exercicio7.Soma;
import exercicios.exercicio7.Valor;

public class MainFactory {
	public static void main(String[] args) throws Exception {
		
		Armazenamento armazenamento = SimpleFactory.createArmazenamento(SimpleFactory.POSTGRESQL);
